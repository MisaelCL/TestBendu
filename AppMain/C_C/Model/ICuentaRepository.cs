...
namespace C_C_Final.Model
{
    public interface ICuentaRepository
    {
        ...
        void CreateCuenta(SqlConnection cn, SqlTransaction tx, string email, string passwordHash, byte estadoCuenta);
        void CreateAlumno(SqlConnection cn, SqlTransaction tx, Alumno alumno);
    }
}
